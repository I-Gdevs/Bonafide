            ...
            <div id="receta-content" style="position: relative; z-index: 1;">
                ...
                <?php if ($receta_seleccionada): ?>
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <?php if ($es_admin): ?>
                            <button 
                                class="btn btn-sm btn-outline-danger btn-edit" 
                ...
                <?php else: ?>
                    <h2 class="fw-bold text-dark">Selecciona un producto para ver la receta</h2>
                    <p class="text-muted">Las recetas, ingredientes y pasos aparecerán aquí.</p>
                <?php endif; ?>
            </div>
        </section>
                        ...
                        <div class="card h-100 product-card <?= $card_active ?>">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <?php if ($es_admin): ?>
                                    <button 
                                        class="btn btn-sm btn-outline-danger btn-edit ms-2"
                                        data-bs-toggle="modal" 
                                        data-bs-target="#editModal" 
                                        data-id="<?= $producto['id'] ?>"
        ...
        <form id="receta-edit-form">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        <label for="edit-imagen" class="form-label small">URL Imagen (Tarjeta)</label>
                        <input type="text" class="form-control" id="edit-imagen">
                    </div>
                    <div class="mb-3">
                        <label for="edit-fondo" class="form-label small">URL Fondo (Receta)</label>
                ...
                <div class="col-md-8">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" id="input-ingrediente" placeholder="Nombre del ingrediente">
                        <input 
                            type="text" 
                            class="form-control" 
                            id="input-cantidad" 
                    ...
                    <div class="mb-3">
                        <label for="edit-pasos" class="form-label small">Pasos (Separados por línea)</label>
                        <textarea class="form-control" id="edit-pasos" rows="4"></textarea>
                    </div>
                </div>
                
                <div class="col-12 mt-4 border-top pt-3">
                    <h6 class="text-danger fw-bold mb-3">Información Principal y Etiquetas</h6>
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <div id="edit-etiquetas-container" class="border p-2 rounded">
                                </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function renderIngredientsTable() {
        ...
        if (activeIngredients.length === 0) {
            tableBody.innerHTML = '<tr><td colspan="3" class="text-center text-muted">No hay ingredientes añadidos.</td></tr>';
            return;
        }
    ...
    function addIngredient() {
        ...
        activeIngredients.push(formattedIngredient);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const displayContainer = document.getElementById('receta-display');
